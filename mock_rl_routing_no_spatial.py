...
DEFAULT_CONFIG = {
    ...
    "paths": {
        ...
        "runs_dir": "runs",
        "run_log_no_spatial_file": "last_run_no_spatial.txt"
    },
}
...
class HazardRoutingEnv:
    ...
    def _build_target_features(self, unvisited):
        ...
        return np.array([n_remaining_norm, n_completed_norm, elapsed_norm], dtype=float)
...
def train(config_path=CONFIG_PATH_DEFAULT, config_overrides=None):
    ...
    run_log_file = str(paths_cfg.get("run_log_no_spatial_file", "last_run_no_spatial.txt"))
                    ...
                    torch.save(
                        {
                            ...
                            "seed": SEED,
                            "model_variant": "no_spatial_neighbor_head",
